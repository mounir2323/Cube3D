...
MAIN_SRCS 					= main.c
PARSING_SRCS				= parsing_module/parsing.c parsing_module/get_colors.c parsing_module/read_map.c parsing_module/check_map_validity.c
...
LAUNCH_GAME_SRCS			= launch_game_module/launch_game.c ray_cast/ray_cast.c init/init.c tex/tex.c \
							ray_cast/draw.c ray_cast/utils.c \
